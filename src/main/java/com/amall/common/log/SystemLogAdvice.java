...
import com.amall.core.web.virtual.LogFieldType;
import com.amall.core.web.virtual.LogType;

/**
 * 
 * <p>
 * Title: SystemLogAdvice
 * </p>
 * <p>
 * Description: 系统日志切面
 * </p>
...
public class SystemLogAdvice
{
	...
	@AfterReturning("execution(* com.amall.core..*.*(..))&& @annotation(annotation)&&args(request,..) ")
	...
	private void saveLog (JoinPoint joinPoint , Log annotation , HttpServletRequest request) throws Exception
		{
			...
			String description = SecurityUserHolder.getCurrentUser ().getTruename () + "于" + CommUtil.formatTime ("yyyy-MM-dd HH:mm:ss" , new Date ());
	...
	@AfterThrowing(value = "execution(* com.amall.core.action..*.*(..))&&args(request,..) " , throwing = "exception")
