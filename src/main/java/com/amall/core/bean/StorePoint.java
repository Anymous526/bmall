...
/**
 * 
 * <p>Title: StorePoint</p>
 * <p>Description: 店铺评分信息</p>
 * <p>Company: www.hg-sem.com</p> 
 * @author	ljx
 * @date	2015年8月19日下午5:12:59
 * @version 1.0
 */
...
public class StorePoint implements Serializable{
    ...
    private BigDecimal descriptionEvaluate;		//描述相符
    ...
    private BigDecimal serviceEvaluate;		//服务态度
    ...
    private BigDecimal shipEvaluate;		//发货速度
