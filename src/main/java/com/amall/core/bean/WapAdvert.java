...
public class WapAdvert implements Serializable{
    ...
    //字段ad_status的默认值从1改为0,1表示审核通过,0表示待审核,新增广告的时候应该默认是待审核状态
    ...
    private Accessory adAcc;     //广告图片
   	...
   	private WapAdvertPositionWithBLOBs adAp;  //广告位置
   	...
   	public WapAdvertPositionWithBLOBs getAdAp() {
   		return adAp;
   	}

   	public void setAdAp(WapAdvertPositionWithBLOBs adAp) {
   		this.adAp = adAp;
   		if(adAp !=null)
