...
public class LuceneUtil
{
	 ...
	 * </p>
	 * <p>
	 * Description: 设置分词器 和要分词的 title 到解析器
	 * </p>
	 */
	public LuceneUtil ( )
	{
	...
	public LuceneResult search (String params , int pageNo , double begin_price , double end_price , ScoreDoc after , Sort sort)
		{
			...
			try
			{
				...
				if (intPageNo < 1)
					intPageNo = 1;
				List <LuceneVo> vo_list = searchIndex (params , (intPageNo - 1) * this.pageSize , this.pageSize , begin_price , end_price , sort);
	 ...
	 * 
	 * <p>
	 * Title: builderDocument
	 * </p>
	 * <p>
	 * Description: 根据luceneVo对象 创建document对象
	 * </p>
	 * 
	 * @param luceneVo
	 * @return document对象
