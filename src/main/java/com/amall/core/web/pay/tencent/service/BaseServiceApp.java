...
public class BaseServiceApp{
    ...
    public BaseServiceApp(String api) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        apiURL = api;
        Class c = Class.forName(Configure.appHttpsRequestClassName);
