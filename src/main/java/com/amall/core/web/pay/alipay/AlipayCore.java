...
public class AlipayCore {
    ...
    public static Map getRequestParams(Map requestParams) throws UnsupportedEncodingException
    {
    ...
    * @date 2016年5月25日
    */
    public static String RSASignMap(String content)
    {
