...
import com.sun.image.codec.jpeg.JPEGImageEncoder;
 ...
 public class ImageCompress extends Frame
 {
	   ...
	   public static void ImageScale(String sourceImg, String targetImg, float width, float height)
	   {
	     try {
	   ...
	   public static float getRatio(float width, float height, float maxWidth, float maxHeight) {
	     float Ratio = 1.0F;
