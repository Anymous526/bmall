package com.amall.core.security.interceptor;
	...
	public void afterPropertiesSet ( ) throws Exception
		{
			...
			if ("true".equals (String.valueOf (this.lowercaseComparisons)))
			{
				if (!this.useAntPath)
					((RegexUrlPathMatcher) this.urlMatcher).setRequiresLowerCaseUrl (true);
			}
			else if (("false".equals (String.valueOf (this.lowercaseComparisons))) && (this.useAntPath))
