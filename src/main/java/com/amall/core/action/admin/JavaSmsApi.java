	...
	public static void main (String [ ] args) throws IOException , URISyntaxException
		{
			...
			String apikey = "8a48b5514eaf512c014eafcf0b9801be ";
			// 修改为您要发送的手机号
			String mobile = "18680340256";
			/**************** 查账户信息调用示例 *****************/
			System.out.println (JavaSmsApi.getUserInfo (apikey));
			/**************** 使用智能匹配模板接口发短信(推荐) *****************/
			// 设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
			String text = "【tianshihuzhu】您的验证码是999999999";
			// 发短信调用示例
			String t = JavaSmsApi.sendSms (apikey , text , mobile);
			 ...
			 * + URLEncoder.encode("999999999", ENCODING) + "&"
			 * + URLEncoder.encode("#company#",ENCODING) + "="
			 * + URLEncoder.encode("明天会更好",ENCODING);
			 * //模板发送的调用示例
