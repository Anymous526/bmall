  ...
  jQuery("a[dialog_uri!=undefined],input[dialog_uri!=undefined],input[dialog_uri!=undefined],input[dialog_uri!=undefined]").click(function(e){
	...
	var dialog_left=300;
	 if(dialog_uri!=undefined&&dialog_uri!=""){
       jQuery("body").append("<div id='"+dialog_id+"'><div class='white_content' style='display:block;'> <a href='javascript:location.reload();' class='white_close' onclick='javascript:jQuery(\"#"+dialog_id+"\").remove();'></a><div class='white_box'><h1>"+dialog_title+"</h1><div class='content_load'></div></div></div><div class='black_overlay'></div></div>");
	   e.preventDefault(); 
       ...
       jQuery(".white_content").css("position","fixed").css("top","-120px").css("display","block").css("left",parseInt(dialog_left)+"px");
