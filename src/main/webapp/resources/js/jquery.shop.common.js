  ...
  jQuery("a[dialog_uri!=undefined],input[dialog_uri!=undefined],input[dialog_uri!=undefined],input[dialog_uri!=undefined]").click(function(e){
	...
	var dialog_left=300;
	 if(dialog_uri!=undefined&&dialog_uri!=""){
       ...
       jQuery(".white_content").css("position","absolute").css("top","20%").css("left",parseInt(dialog_left)+"px").css("height","inherit").css("margin-top",0);
	  ...
	  /*jQuery("#"+dialog_id+" .white_content").draggable({handle:" .white_box h1"});*/
	   ...
	   var con_w = $(".white_content").width();
	   var con_h = $(".white_content").height();
	   var win_con_w = (win_w - dialog_width)/2;
	   var win_con_h = (win_h - con_h)/2;
	   $(".white_content").css({"top":"30%","right":"40%"});
