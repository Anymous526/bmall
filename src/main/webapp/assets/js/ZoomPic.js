...
{var _this=this;this.wrap=typeof id==="string"?document.getElementById(id):id;this.oUl=this.wrap.getElementsByTagName("ul")[0];this.aLi=this.wrap.getElementsByTagName("li");this.prev=this.wrap.getElementsByTagName("pre")[0];this.next=this.wrap.getElementsByTagName("pre")[1];this.timer=null;this.aSort=[];this.iCenter=3;this._doPrev=function(){return _this.doPrev.apply(_this)};this._doNext=function(){return _this.doNext.apply(_this)};this.options=[{width:320,height:320,top:152,left:0,zIndex:1},{width:320,height:320,top:152,left:0,zIndex:2},{width:320,height:320,top:152,left:200,zIndex:3},{width:400,height:400,top:120,left:388,zIndex:4},{width:320,height:320,top:152,left:668,zIndex:3},{width:320,height:320,top:152,left:834,zIndex:2},{width:320,height:320,top:152,left:450,zIndex:1},];for(var i=0;i<this.aLi.length;i++)this.aSort[i]=this.aLi[i];this.aSort.unshift(this.aSort.pop());this.setUp();this.addEvent(this.prev,"click",this._doPrev);this.addEvent(this.next,"click",this._doNext);this.doImgClick();this.timer=setInterval(function()
